...
export class HomedecoreService {
  ...
  home: Homedecore[] = [
    {
      pid: 1,
      pname: 'Sofa set',
      pdescription: 'A sofa is a long, comfortable seat with a back and usually with arms, which two or three people can sit on.',
      price: 15500,
  ...
  public getHomedecoreDetails(): any {
    const homeObservable = new Observable(observe => {
      setTimeout(() => {
        observe.next(this.home);
      }, 1000);
    });
